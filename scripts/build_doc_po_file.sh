...
copy_file() {
    cp -rf doc/locales/en/LC_MESSAGES/*.po build_doc_po_file/bigflow/doc/en/LC_MESSAGES/
    cp -rf doc/locales/zh/LC_MESSAGES/*.po build_doc_po_file/bigflow/doc/zh/LC_MESSAGES/
